...
ActiveRecord::Schema.define(version: 2019_03_18_002251) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.index ["specialties_id"], name: "index_users_on_specialties_id"
    t.index ["uid", "provider"], name: "index_users_on_uid_and_provider", unique: true
  end

  add_foreign_key "services", "specialties"
  add_foreign_key "users", "specialties", column: "specialties_id"
end
